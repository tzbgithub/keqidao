package com.qidao.qidao.link.organizationSalesman.domain;

import java.time.LocalDateTime;
import java.util.ArrayList;
import java.util.List;

public class ILinkOrganizationSalesmanExample {
    ...
    public ILinkOrganizationSalesmanExample() {
    ...
    public ILinkOrganizationSalesmanExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public ILinkOrganizationSalesmanExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public ILinkOrganizationSalesmanExample page(Integer page, Integer pageSize) {
